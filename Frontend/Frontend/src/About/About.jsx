...
function AboutUs() {
  return (
    <div>
      <Navbar />
      <div className="mt-10  bg-gradient-to-r from-blue-100 via-purple-100 to-pink-100 min-h-screen flex flex-col items-center justify-center">
        <div className="bg-white p-8 rounded-lg shadow-2xl max-w-4xl w-full transform transition-all hover:scale-105">
          <h2 className="text-5xl font-extrabold mb-10 text-center text-pink-800">
            About Us
          </h2>
          ...
          <div className="mt-12 text-center">
            <h3 className="text-3xl font-extrabold text-purple-700 mb-8">
              Meet Our Team
            </h3>
